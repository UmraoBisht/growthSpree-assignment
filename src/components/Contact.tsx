            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff7a5c] focus:border-transparent"
              ...
              <div className="flex items-start">
                <input
                  ...
                  className="mt-1 h-4 w-4 text-[#ff7a5c] focus:ring-[#ff7a5c] border-gray-300 rounded"
                  required
                />
